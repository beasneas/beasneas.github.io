...
app.use(express.static(path.join("C:\GITHUB CLONE\beasneas.github.io\public")));
...
router.get('/', function(req, res){
    ...
    res.sendFile(path.join("C:\GITHUB CLONE\beasneas.github.io\public\gradebook.html"));
});
